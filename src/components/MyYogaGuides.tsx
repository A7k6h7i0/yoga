...
const MyYogaGuides = () => {
  const guides = [
    { name: 'Priya Sharma', expertise: 'Vinyasa & Hatha Expert', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&q=80' },
    { name: 'Sujith', expertise: 'Ashtanga Master', image: '/guide.png' },
    { name: 'Dr. Meera', expertise: 'Therapeutic Yoga', image: 'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?auto=format&fit=crop&q=80' },
  ];
