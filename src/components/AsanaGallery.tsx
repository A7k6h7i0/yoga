...
const AsanaGallery = () => {
  const poses = [
    { name: 'Vrikshasana', translation: 'Tree Pose', img: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&q=80' },
    { name: 'Adho Mukha', translation: 'Down Dog', img: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&q=80' },
    { name: 'Trikonasana', translation: 'Triangle Pose', img: 'https://images.unsplash.com/photo-1510894347713-fc3ed6fdf539?auto=format&fit=crop&q=80' },
    { name: 'Virabhadrasana', translation: 'Warrior II', img: 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?auto=format&fit=crop&q=80' },
  ];
