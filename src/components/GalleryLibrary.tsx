  ...
  return (
    <div className="bg-white rounded-[2rem] overflow-hidden border border-sky-100 flex flex-col h-full shadow-sm hover:shadow-2xl transition-all duration-500 group">
      ...
      <div className="p-8 pt-12 flex flex-col flex-grow">
        ...
        <button className={`flex items-center justify-center gap-2 px-4 py-2.5 rounded-full border-2 ${buttonColor} font-bold text-sm tracking-widest group/btn transition-all duration-300 hover:shadow-lg`}>
          {buttonText}
