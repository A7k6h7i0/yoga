    ...
    <section className="py-24 bg-sky-50 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            Join expert-designed 30-day programs and challenges that help you build discipline,
            stay motivated, and create lasting change—one day at a time.
          </motion.p>
        </div>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {selectedProgram.follow.map((item, i) => (
                  ...
                  <div className="bg-sky-50 rounded-3xl p-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedProgram.bestFor.map((item, i) => (
