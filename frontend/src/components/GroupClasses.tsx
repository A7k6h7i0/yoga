      ...
      <div className="w-full px-4 md:px-8 lg:px-20">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2">
            ...
            >
              <img 
                src="https://images.unsplash.com/photo-1758274525946-2d3a5be67b5d?q=80&w=1331&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
