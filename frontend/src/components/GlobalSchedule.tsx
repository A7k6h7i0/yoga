...
const GlobalSchedule = () => {
  ...
  // Moon animates UP from the bottom and fades in during the second half
  const moonY = useTransform(scrollYProgress, [0.4, 0.9], [650, 0]);
  const moonOpacity = useTransform(scrollYProgress, [0.4, 0.6], [0, 1]);
        ...
        <div className="schedule-components-wrapper">
          ...
          <div className="schedule-animation-container">
            <div className="schedule-animation-wrapper">
              <img 
                sizes="100vw" 
                srcSet="https://cdn.prod.website-files.com/67691f03eb5bfa3289b3daed/6769218dbe8c0679c8ea0e4f_schedule-section-lady-image.avif 500w, https://cdn.prod.website-files.com/67691f03eb5bfa3289b3daed/6769218dbe8c0679c8ea0e4f_schedule-section-lady-image.avif 800w, https://cdn.prod.website-files.com/67691f03eb5bfa3289b3daed/6769218dbe8c0679c8ea0e4f_schedule-section-lady-image.avif 2877w" 
                alt="" 
                  ...
                  <svg width="100%" height="100%" viewBox="0 0 601 1204" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_2078_272)">
                      ...
                      <g filter="url(#filter0_b_2078_272)">
                        <rect className="blur-schedule" x="83.9844" y="96" width="393.617" height="665.885" rx="8.62855" fill="#EAE4DF" fillOpacity="0.5"></rect>
                      </g>
                      ...
                      >
                        <motion.tspan id="svg-date-text-1" x="0" y="29.9375">
                          {useTransform(scrollYProgress, (v) => v > 0.5 ? "9:00pm" : "5:00pm")}
                        </motion.tspan>
                      </motion.text>
                      <motion.text 
                      ...
                      >
                        <tspan id="svg-date-text-2" x="0" y="23.0847">
                          <motion.tspan x="0" dy="0">{useTransform(scrollYProgress, (v) => v > 0.5 ? "Meditation" : "Yoga Nidra")}</motion.tspan>
                          <motion.tspan x="0" dy="1.2em">{useTransform(scrollYProgress, (v) => v > 0.5 ? "with Sarah" : "with Anand Patel")}</motion.tspan>
                        </tspan>
                      </motion.text>
                      <rect x="132.54" y="352.944" width="180.154" height="52.9659" rx="24.5914" transform="rotate(0.170627 132.54 352.944)" stroke="#808080" strokeWidth="0.862855"></rect>
                      <motion.text 
